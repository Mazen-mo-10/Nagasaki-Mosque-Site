      ...
      <section className="bg-gradient-hero text-white py-20 px-4 pattern-islamic">
        <div className="container mx-auto text-center space-y-6 relative z-10">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto animate-slide-up">
            Join our vibrant community in Islamic celebrations and educational programs
          </p>
        </div>
      </section>
...
const upcomingEvents = [
  {
    ...
    description: "Join us for the joyous celebration of Eid al-Fitr with community prayers, traditional food, and cultural activities.",
    date: "April 10, 2024",
  ...
  },
  {
    ...
    description: "Weekly Quran study and discussion group for deeper understanding of Islamic teachings.",
    date: "Every Friday",
  ...
  },
  {
    ...
    category: "Cultural",
    description: "Learn the beautiful art of Arabic calligraphy with traditional techniques and modern applications.",
    date: "March 15, 2024",
  ...
  },
  {
    ...
    description: "Building bridges between communities through respectful dialogue and understanding.",
    date: "March 22, 2024",
  ...
  },
  {
    ...
    description: "Interactive Islamic education sessions designed specifically for young Muslims in Japan.",
    date: "Every Saturday",
  ...
  },
  {
    ...
    description: "Breaking fast together during the holy month of Ramadan, fostering unity and brotherhood.",
    date: "During Ramadan",
    time: "Maghrib Time",
...
const regularPrograms = [
  {
    ...
    description: "Weekly congregational prayers with Islamic sermons and community gathering.",
  ...
  },
  {
    ...
    description: "Learn to read and understand Arabic for better Quran comprehension.",
  ...
  },
  {
    ...
    description: "Age-appropriate Islamic education for children in our community.",
    schedule: "Sundays",
    duration: "2 hours",
    icon: Users,
  ...
  },
  {
    ...
    description: "Sisters' gathering for Islamic discussions, support, and sisterhood.",
    schedule: "Monthly",
    duration: "2 hours",
    icon: Users,
